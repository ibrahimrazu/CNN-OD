...
#    acc_dict_train['L1'].append(epoch_acc1)
#    acc_dict_train['H1'].append(epoch_acc2)
#    acc_dict_train['L2'].append(epoch_acc3)
#    acc_dict_train['H2'].append(epoch_acc4)
#    acc_dict_train['L3'].append(epoch_acc5)
#    acc_dict_train['H3'].append(epoch_acc6)
...
for i in range(3):  
    ...
    for experment_num in range(0,5): # do two experiments
...
# Future to-do
    ...
    #list1 = [x-5 for x in acc_dict['Depth']]
#list2 = [x-5 for x in acc_dict['Width']]